...
public class BorrowerTableModel extends AbstractTableModel implements TableModel {
	...
	private static final String[] COL_NAMES_DISP = {"Banner ID","First Name","Last Name","Phone","Email","Status","Monetary Penalty","Date Last Updated"};
	...
	public BorrowerTableModel(List<Borrower> bookData) {
		...
		for(Borrower b : bookData) state.add(b.getPersistentState());
	}
